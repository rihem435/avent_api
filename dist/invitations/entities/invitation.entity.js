...
exports.InvitationSchema = exports.InvitationEntity = void 0;
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let InvitationEntity = class InvitationEntity extends mongoose_2.Document {
};
...
__decorate([
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], InvitationEntity.prototype, "event_id", void 0);
exports.InvitationEntity = InvitationEntity = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], InvitationEntity);
exports.InvitationSchema = mongoose_1.SchemaFactory.createForClass(InvitationEntity);
